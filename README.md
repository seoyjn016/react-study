...
- html 의 태그의 활용 이전에 꼭 체크 해 보자.
  : https://caniuse.com/ 의심가면 확인해 보자. -디자인을 살펴보고 영역을 구분하는 작업 진행
  : 레이아웃을 위한 영역(div)
  : 내용별 배치 영역
...
- `git remote add origin https://github.com/seoyjn016/blog-kakaobrain-seoyjn016.git`

### 3.5 깃을 깃허브로 push 후 퇴근 한다. (매일 퇴근전, 필요시)

- `git push -u origin main`

### 3.6. 브랜치 나누기(나뭇가지 - 코드분기) 나누기
